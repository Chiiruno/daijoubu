...
// Server configurations of this specific instance passed from config file.
// Immutable after loading.
var Server ServerConfigs

// ImagerModeType is the imager functionality setting for this process
...
func (c *ServerConfigs) setDefaults() {
	c.Debug = true
	c.Database = "postgres://daijoubu:daijoubu@localhost:5432/daijoubu?sslmode=disable"
	c.CacheSize = 128
	c.Server.Address = ":8000"
	c.Test.Database = "postgres://daijoubu:daijoubu@localhost:5432/daijoubu_test?sslmode=disable"
}
